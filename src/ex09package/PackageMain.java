...
import ex09package.kosmo.util.CommonUtil;//임포트를 하는 이유: 팩키지가 서로 다르기 때문에 불러와서 사용한다.ex: Scanner
...
public class PackageMain {
	...
	public static void main(String[] args) {
		...
		방법2: 하나의 클래스는 import하고 다른 하나만 풀 경로를 사용한다. (지금차용한 방법)
		 */
		...
		이 두 개는 서로 다른 패키지로 인식한다. 따라서 isNumber() 메소드를 호출하기 위해서는
		해당 패키지를 import해야한다.
		 */
