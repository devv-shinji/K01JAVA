...
public class E03CharBooleanType {
	...
	public static void main(String[] args) {
		...
		/*
		아스키코드: 1byte로 표현할 수 있는 문자(영문, 숫자)를 십진수코드로 정의한것을 말함.
			Ex) A=> 65로 표현
				a=> 97로 표현
		...
		char ch4_1 = '1' + 1;
		System.out.println("ch4="+ ch4//문자1
				+", ch4_1="+ ch4_1//문자2
				+", ch4_1="+ (int)ch4_1);//아스키코드49+숫자1=50
		...
		/*
		&& : 논리And 연산으로 양쪽 모두 참일때 참을 반환한다. (모두참일때 참)
			나머지는 거짓을 반환한다.
		|| : 논리Or 연산으로 둘중 하나만 참이면 참을 반환한다. (모두거짓일때 거짓)
			둘다 거짓일때 거짓을 반환한다.
		 */
		boolean bn3 = bn1 && bn2;
