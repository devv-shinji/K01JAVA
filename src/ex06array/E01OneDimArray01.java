...
public class E01OneDimArray01 {
	...
	public static void main(String[] args) {
		...
		주소 값을 반환한다. 그래서 배열명(배열변수)는 주소값(참조값)
		 ...
		 */
		int[] arrNumber = new int[40]; //int형 배열 or 기본자료형 배열 or 정수형
		 ...
		 */
		String[] strArr = new String[3]; //객체배열
		strArr[0] = "java";
		strArr[1] = "jsp";
		strArr[2] = "spring";
		...
		//int[] initArr2 = new int[3] {1, 20, 300}; //에러발행
		int[] initArray2 = new int[] {1, 20, 300};
		
		/*
		배열 요소의 갯수를 통해 배열을 즉시 생성한다. 이 때
		new 키워드는 생략한다.
		 */
