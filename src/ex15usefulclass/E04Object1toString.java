 ...
 */
class myFriends extends Object {//extends Objects는 생략가능하나 지금은 명시적 예시.
	String myName;
...
- 필요한 경우 클래스를 정의할 때 적절히 오버라이딩하여 재정의하는 것이 좋다. 단 필수사항은 아니다.
 */
...
public class E04Object1toString {
	...
	public static void main(String[] args) {
		...
		System.out.println(fnd1); //이름이 출력(toString에서 정의한)
		System.out.println(fnd2); //인스턴스의 주소값이 출력
	}
