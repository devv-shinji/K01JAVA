...
class Point {
	...
	/*
	객체1, 객체2의 x,y값을 동시에 비교해서 둘 다 동일할 때 같은 객체로 판단하도록 오버라이딩 처리
	 */
	@Override
	public boolean equals(Object obj) {//Point객체->Object타입으로 자동형변환(업캐스팅)
		if (obj instanceof Point) {//Point랑 연관있니? (상속관계가 있니?)
			Point pos = (Point)obj;
...
public class E04Object3Equals {
	...
	public static void main(String[] args) {
		...
		System.out.println("pos1.toString()=>"+ pos1);//위와 동일
		System.out.println("pos2.toString()=>"+ pos2);//위와 동일
