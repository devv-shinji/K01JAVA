...
public class E01WrapperClass2 {
	...
	public static void main(String[] args) {
		 ...
		 */
		String money = "120원";
		//System.out.println("120원:"+ Integer.parseInt(money));//출력시 에러발생
		...
		//System.out.println(Integer.parseInt(floatString));//출력시 에러발생
		...
		/*
		4] isLetter(): 인자의 문자여부를 판단하는 메소드로 특수기호나 숫자형은 false를 반환한다. 
		 */
		...
		/*
		5] isWhitespace(): 공백문자인지 판단하는 메소드.(true반환)
		 */
