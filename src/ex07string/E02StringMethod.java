	...
	public static void main(String[] args) {
		...
		4] compareTo(): 두 문자열을 첫번째 문자부터 순차적으로
			비교하면서 
				...
				같으면 0을 반환한다.
		 */
		String str3 = "A";//ex)아스키코드 60
		String str4 = "B";//es)아스키코드 60+1
		...
		9] format()
			...
			printf()와 사용법은 동일하고 주로 웹어플리케이션(JSP)==(홈페이지)를
			제작할 때 사용된다.
		 */
		...
		13] split()
			...
			반환한다. 해당 구분자라 없는 경우에는 크기가 1인 String
			배열로 반환한다.
		 */
