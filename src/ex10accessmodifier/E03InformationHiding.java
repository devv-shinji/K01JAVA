...
class FruitSeller {
	...
	private int APPLE_PRICE; //다시 상수로선언. 클래스 내의 상수여서 선언과 동시에 초기화 해야 하지만, 아래의 생성자메소드에서 초기화가 가능하다.
	
	
	public FruitSeller(int money, int appleNum, int price) { //생성자(함수인듯 함수아닌 너)
		myMoney = money;
		numOfApple = appleNum;
