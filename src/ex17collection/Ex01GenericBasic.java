...
public class Ex01GenericBasic {
	...
	public static void main(String[] args) {
		...
		/*
		상자1은 오렌지 전용박스이므로 다른과일(즉 객체(String객체포함))을 저장할 수 없다.
		컴파일 에러가 발생하므로 실행자체가 불가능하다.
		-> 자료형에는 안전하지만, 구현에는 불편함이 따른다.
		다른 객체를 저장하기 위해서는 또 다른 Box클래스를 생성해야 한다.
		 */
		/*
		oBox1.store("당도가 20인 오렌지");//컴파일 에러 (Syntax Error)
		...
		*/
		...
		FruitBox fBox2 = new FruitBox("당도가 30인 오렌지");//컴파일에러는 없지만 런타임에러 발생됨
