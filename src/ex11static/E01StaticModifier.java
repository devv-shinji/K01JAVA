...
- 정적변수는 JVM(자바가상머신)에 의해 프로그램이 로드되는 시점에 초기화 된다. (메소드영역에 이미 사용할 준비가 된다.)
- main 메소드가 실행되기 전에 이미 초기화 되므로 main메소드 실행시
...
public class E01StaticModifier {
	...
	public static void main(String[] args) {
		...
		/*
		static(정적) 멤버변수 접근방법
		방법1: 클래스명을 통해서 접근한다. 객체 생성없이 클래스명으로 바로 접근하는 것이 가능하다.
		 */
		MyStatic.staticVar = 200;//클래스명.변수명 ==> 권장하는 방법★★★
