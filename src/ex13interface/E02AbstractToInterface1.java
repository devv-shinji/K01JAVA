...
- 객체생성은 할 수 없으나 그외 참조변수, 상속등의 모든 기능을 가지고 있다.
...
class PersonalNumberStorageExt extends PersonalNumberStorageAbs {
	...
	public void addPersonalInfo(String juminNum, String name) {
		...
		numOfPerInfo++;
//		personalArr[numOfPerInfo++] = new PersonalInfoDTO(name, juminNum);이렇게표현도가능
	}

	/*
	주민번호를 인자로 전달받아 객체배열에 저장되니 정보를 검색한 후 일치하는 경우에만 이름을 반환한다.
	 */
	@Override
...
public class E02AbstractToInterface1 {
	...
	public static void main(String[] args) {
		...
		//정보저장
		storage.addPersonalInfo("901212-222222", "김태희");
		storage.addPersonalInfo("901212-111111", "정지훈");
		
		//검색
		System.out.println(storage.searchPersonalInfo("901212-222222"));
		System.out.println(storage.searchPersonalInfo("901212-111111"));
		System.out.println(storage.searchPersonalInfo("001211-333333"));
