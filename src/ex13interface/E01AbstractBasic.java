 ...
 */
abstract class AbsClass1{//객체생성이 불가한 추상클래스
...
public class E01AbstractBasic {
	...
	public static void main(String[] args) {
		...
		//AbsClass1 absClass1 = new AbsClass1();//abstract 클래스는 객체화 할 수 없음
		...
		((absClassChild2)absClass2).newMethod();//자식클래스형으로 강제형변환함.
		//부모타입의 참조변수로 자식객체에 접근하려면 다운캐스팅(강제형변환) 후 접근해야 한다.
		
		/*
		추상클래스내에 선언된 정적멤버는 오버라이딩의 대상이 될 수 없으므로
