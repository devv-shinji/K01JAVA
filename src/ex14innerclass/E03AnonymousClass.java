...
- 부모클래스의 메소드를 오버라이딩 하는 것이 목적이다(이미 상속의 개념이 포함되어있다).
...
public class E03AnonymousClass {
	...
	public static void main(String[] args) {
		 ...
		 */
		/*
		Person anonyTest = new Student("다운캐스팅", "안된다") {
			String jumin = "001024";
		};
		((Student)anonyTest).jumin = "181105"; //익명클래스이기에 Person이나 Student형으로 변환자체가 안됨.
		*/
		
		
		//추상클래스를 상속받은 익명클래스
		AbstractClss ac = new AbstractClss() {
			String abStr = "확장변수";
			@Override
			void abstractMethod() {
