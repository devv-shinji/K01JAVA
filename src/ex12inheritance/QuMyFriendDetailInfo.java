...
class MyFriendDetailInfo extends MyFriendInfo {
	private String addr;
  	...
  	public MyFriendDetailInfo(String _name, int _age, 
  		...
  		super(_name, _age);//부모를 위해 전달
  		addr = _addr;//자식 자신을 위해
  		phone = _phone;//자식 자신을 위해
	...
	public void ShowMyFriendDetailInfo() {
		 ...
		 */
		super.ShowMyFriendInfo();//super를 안붙여도 되지만 명시적으로 기재
...
class QuMyFriendDetailInfo {
	public static void main(String[] args)
	{
		...
		MyFriendDetailInfo info = 
				new MyFriendDetailInfo("랩몬스터", 27, "빅히트ent", "010-1234-2222");
		//정보Print
