...
public class DeChild extends DeParent {//자식클래스 선언
	//멤버변수: 자식에서 확장한 변수
	 ...
	 */
	private void eat() {//private이어서 오버라이드 안됨
	...
	그보다 넓으면 가능하다. 
	- 즉, 부모에서 default일 때 자식쪽에서 default, public이면 오버라이딩 가능
	 */
	@Override
	public String sleep() {//부모는 default지만 public범위가 더 넓어서가능
	 ...
	 */
	public int walk(int age) {//오버라이딩 아님. 접근지정자다르고, 매개변수다름
